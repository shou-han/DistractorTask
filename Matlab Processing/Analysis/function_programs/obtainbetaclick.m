function [betaClick] = obtainbetaclick( data_used, t, RT_used, increment_window_size,resplocked)
%obtainbetaclick( data_used, t, RT_used, increment_window_size,resplocked)
...
if ~resplocked
    for trial = 1:size(data_used,2)
        ...
        betaClicklevel(trial) = mean(sigDiffData);
    end
