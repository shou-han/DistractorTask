...
figpaths = "/home/szhou/yn70_scratch/ShouHan/Distractors/mainProgs_final/R_stats/Figures/10dots"
source( "indirectMLM.R" )
library( boot )
dataRawA <-read.csv("Stats/mediateAllcongCSDAccold.csv", header=FALSE, stringsAsFactors = FALSE)
dataRaw <- read.csv("Stats/mediateAllCSDold.csv", header=FALSE, stringsAsFactors = FALSE)
dataRawG<-read.csv("Stats/mediateAllGsold.csv", header=FALSE, stringsAsFactors = FALSE)
...
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/RT_bar_graphs10dots.png')))
```
```{r RT stats}
...
#plotfigureHit
Speed_checker_part <- data %>% group_by(ID,distractor,Accuracy,cong) %>% summarise(meanRT  = mean(RT , na.rm=TRUE))
...
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/N2pcxdist10dots.png')))
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/N2cxdist10dots.png')))
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/N2ixdist10dots.png')))
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/N2c_i10dots.png')))
```
...
dataTemp<-plevelAll%>%filter(!(ID %in% 5))
getStats(data=dataTemp,
...
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/beta_stim10dots.png')))
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/beta_resp10dots.png')))
knitr::include_graphics((rep('../analysisScript/Figures/10dotsMatlab/betaR10dots.png')))
```
